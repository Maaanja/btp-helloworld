		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comcicdcicdpoc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcicdcicdpoc-display": {
								"semanticObject": "comcicdcicdpoc",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.cicd.cicdpoc",
									"url": sap.ui.require.toUrl("com/cicd/cicdpoc")
								}
							}
						}
					}
